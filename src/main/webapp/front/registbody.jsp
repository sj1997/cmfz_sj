...
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/boot/js/jquery-3.3.1.min.js"></script>
...
<script type="text/javascript" language="javascript">
    ...
    function setBgColor() {
        ...
        $option.css({ "background-color": "#DEDEDB" });
...
<div class = "container-fluid">
    <form class="form-horizontal" action="${pageContext.request.contextPath}/user/regist" method="post" enctype="multipart/form-data" id = "myform">
        <div class = "row">
            <div class = "col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type = "text" name = "profile" class = "form-control" id = "inputEmail3" placeholder="昵称..."/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">法名</label>
                    <div class="col-sm-10">
                        <input type = "text" name = "dharmaName" class = "form-control" id = "inputPassword3" placeholder="法名...">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputPassword5" class="col-sm-2 control-label">再次输入密码</label>
                    <div class="col-sm-10">
                        <input type = "text" class = "form-control" onblur="yz()"  id = "inputPassword5" placeholder="再次输入密码..."/>
                    </div>
                </div>
            ...
            <div class = "col-sm-4">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type = "file" name = "file" id = "inputfile" placeholder="sss"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="radio radio-inline" id="optionsRadios1">
                        <label>
                ...
                <div class="form-group">
                    <label for="inputpersonal" class="col-sm-2 control-label">*地区</label>
                    <div id = "inputpersonal">
                        省  份：<select id="selProvince" onchange="provinceChange();" name = "province" class = "form-control-static"></select>

                        市(区)：<select id="selCity" name = "city" class = "form-control-static"></select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputpersonalSign" class="col-sm-2 control-label">*个性签名</label>
                    <div class="col-sm-10">
                        <input type = "text" name = "personalSign" class = "form-control" id = "inputpersonalSign" placeholder="个性签名..." />
                    </div>
                </div>
            </div>
            <div class = "col-sm-4">
                <div class="form-inline form-group">
                        <div class="input-group">
                            <input type="text" id = "phone1" onblur="testphone()" name = "phone" width = "5px" placeholder="请输入有效手机号"/>
                        </div>
                ...
                <div id = "sz">
                    <button id = "qqq" type="button" class = "btn-success form-group">立即注册</button>
                </div>
            </div>
        </div>
    </form>
