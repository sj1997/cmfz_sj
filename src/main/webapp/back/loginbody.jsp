...
<div class="row">
  ...
  <div class="col-md-4">
    <form class="form-horizontal" id="form" method="post" action="${pageContext.request.contextPath}/admin/login" onsubmit="return false">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="inputEmail3" placeholder="Username..." name = "username" width="1px" onfocus="rem()">
...
<div class="modal  loadMoal" id = "mymo1"  id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabe2">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
